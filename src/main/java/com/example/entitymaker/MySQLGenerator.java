...
public class MySQLGenerator implements Initializable {
    String script = "";
    String alterScript = "";
    String linkScript = "";
    @FXML TextArea textArea;
    @FXML TextField jdbcField;
    ...
    public void pushScript() throws SQLException {
        ...
        try {
            connection = DriverManager.getConnection(jdbcField.getText(), usernameField.getText(), passField.getText());
        } catch (SQLException e) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Connection Error");
            alert.setHeaderText("Connection Error");
            alert.setContentText(e.getMessage()+"\nCheck the JDBC String, Username and password fields");
            alert.show();
        }
